...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">Edit Blog</h4>
                    ...
                    <form action="{{ route('admin.update_blog',$blog->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" value="{{ $blog->title }}" id="name" name="title">
                                @error('title')
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 col-sm-12">
                                ...
                                <textarea name="post" id="my-editor" class="form-control">
                                    {{ $blog->post }}
                                </textarea>
                            @error('post')
                            <span class="text-danger text-center">{{$message}}</span>
                        ...
                        <div class="col-xl-6 mg-t-25 mg-xl-t-0">
                            ...
                            <div class="row row-xs mg-t-20">
                                <img id="image" style="width: 150px" src="{{ asset('images/blog/thumbnail/'. $blog->thumbnail ) }}" alt="">
                            </div><!-- row -->
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Update Blog</button>
                    </form>
                </div>
            </div>
        </div>
