...
$.extend($.easing, {
    ...
    return function() {
        ...
        }), null) : null === Riode.initProductSingle(o) ? null : (Riode.$body.on("click", ".product-single .product-image-full", t), Riode.$body.on("click", ".single-product .btn-cart:not(.disabled)", e), Riode.zoomImage(".product-gallery.row"), void Riode.$body.on("click", ".rating-form .rating-stars > input[type=radio]", function(e) {
            var t = $(this);
